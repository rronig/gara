        ...
        <div class="sidebar bg-blue-800 text-white w-64 fixed h-full">
            ...
            <nav class="mt-6">
                ...
                <div class="px-4 py-2 hover:bg-blue-700">
                    <a href="profile.php" class="flex items-center text-white">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
                        ...
                        <div class="mt-4 md:mt-0">
                            <div class="bg-white bg-opacity-20 p-4 rounded-lg">
                                ...
                                <p class="text-2xl font-bold">€245,890</p>
                                <p class="text-sm mt-1">+12.5% from last month</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <?php else: ?>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <?php else: ?>
                                    <div class="mt-4 text-center">
                                        ...
                                        <a href="company_profile.php" class="text-blue-600 hover:text-blue-800 font-medium">Add Company Profile</a>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-lg shadow p-6">
                            ...
                            <div class="space-y-3">
                                <button class="w-full flex items-center p-3 bg-blue-50 text-blue-600 rounded-md hover:bg-blue-100 transition">
                                    <i class="fas fa-plus-circle mr-3"></i>
                                    <span>Add New Investment</span>
                                </button>
                                <button class="w-full flex items-center p-3 bg-green-50 text-green-600 rounded-md hover:bg-green-100 transition">
                                    <i class="fas fa-file-export mr-3"></i>
                                    <span>Generate Report</span>
                                </button>
                                <button class="w-full flex items-center p-3 bg-purple-50 text-purple-600 rounded-md hover:bg-purple-100 transition">
                                    <i class="fas fa-search mr-3"></i>
                                    <span>Find Opportunities</span>
                                </button>
                                <button class="w-full flex items-center p-3 bg-yellow-50 text-yellow-600 rounded-md hover:bg-yellow-100 transition">
                    ...
                    <div class="bg-white rounded-lg shadow overflow-hidden mb-6">
                        ...
                        <div class="p-4 border-t text-center">
                            <button class="text-blue-600 hover:text-blue-800 font-medium">View All Opportunities</button>
                        </div>
                    </div>
